...
let input = Number(prompt("Nhập số bàn thắng tối thiểu mà bạn muốn lọc:"));

if (!isNaN(input)) {
    getFilteredTotalGoals(input, players);
} else {
    console.log("Dữ liệu không hợp lệ. Vui lòng chạy lại và nhập một con số.");
}